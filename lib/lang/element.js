...
element.prototype.eq = function (type) {
    var v = type.value && type.value() || type;
    return this.value().toString() === v.toString() ? 1 : 0;
};
...
element.prototype.rest = function (type) {
    return this.states.length - this.size(type);
};
